 ...
 *
 * Обрабатывает HTTP-запросы, связанные с финансовыми операциями, такими как
 * получение баланса, перевод денег и получение истории транзакций.
 */
class FinanceServer {
 private:
  crow::SimpleApp app;
 ...
 public:
   ...
   * Redis, а также настраивает маршруты API.
   *
