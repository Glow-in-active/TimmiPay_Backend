 ...
 *
 * @param redis Ссылка на объект sw::redis::Redis, используемый для взаимодействия с Redis.
 */
 ...
 * @return true, если сессия действительна и ID пользователя получен успешно, false в противном случае.
 */
