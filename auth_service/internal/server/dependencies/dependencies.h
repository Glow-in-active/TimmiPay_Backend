...
/**
 * @brief Структура, содержащая ключевые зависимости для приложения аутентификации.
 *
 ...
 *
 * @param db Ссылка на структуру DBConnections, содержащую соединения с PostgreSQL и Redis.
